...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Программа запускает локальный сервер вашего сайта"
    )
    parser.add_argument(
        "-f",
        "--file",
        default="wines.xlsx",
        help="Имя файла или абсолютный путь к файлу (По умолчанию: wines.xlsx)"
    )
